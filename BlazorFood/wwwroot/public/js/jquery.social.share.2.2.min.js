 ...
 * https://www.designchemical.com/blog/index.php/premium-jquery-plugins/jquery-social-share-buttons-plugin/
...
"//",name="/";var email=o.email.replace(domain,".").replace(name,"@");email=email.split("").reverse().join("");var mailto="mailto:"+email;return mailto},pinit:function(){var e=document.createElement("script");e.setAttribute("type","text/javascript");e.setAttribute("charset","UTF-8");e.setAttribute("src","https://assets.pinterest.com/js/pinmarklet.js?r="+Math.random()*99999999);document.body.appendChild(e)},buttons:function(type){var b='<div class="dcssb-btn dcssb-'+type+" size-"+o.size+'">';var btn=
"none";switch(type){case "twitter":if(o.size=="vertical")btn="vertical";else if(o.size=="horizontal")btn="horizontal";b+='<a href="https://twitter.com/share" data-url="'+url+'" data-counturl="'+url+'" data-text="'+o.title+'" class="twitter-share-button" data-count="'+btn+'" data-via="'+o.twitterId+'"></a><script type="text/javascript" src="https://platform.twitter.com/widgets.js"><\/script>';break;case "facebook":btn="standard";var w=120;var h=24;if(o.size=="vertical"){btn="box_count";h=62}else if(o.size==
"horizontal"){btn="button_count";w=80}b+='<iframe src="https://www.facebook.com/plugins/like.php?app_id=&amp;href='+erl+"&amp;send=false&amp;layout="+btn+"&amp;width="+w+"&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height="+h+'" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:'+w+"px; height:"+h+'px;" allowTransparency="true"></iframe>';break;case "plusone":btn="medium";var count="false";if(o.size=="vertical"){btn="tall";count="true"}else if(o.size==
...
url+'" data-counter="'+btn+'"><\/script>';break;case "stumbleupon":btn="4";var w="60px";var h="24px";if(o.size=="vertical"){btn="5";w="50px";h="60px"}else if(o.size=="horizontal"){btn="1";var w="80px"}b+='<iframe src="https://www.stumbleupon.com/badge/embed/'+btn+"/?url="+erl+'" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:'+w+"; height: "+h+';" allowTransparency="true"></iframe>';break;case "digg":btn="DiggIcon";if(o.size=="vertical")btn="DiggMedium";else if(o.size=="horizontal")btn=
"DiggCompact";b+='<script type="text/javascript">(function() {var s = document.createElement("SCRIPT"), s1 = document.getElementsByTagName("SCRIPT")[0]; s.type = "text/javascript"; s.async = true; s.src = "https://widgets.digg.com/buttons.js"; s1.parentNode.insertBefore(s, s1); })(); <\/script><a href="https://digg.com/submit?url='+erl+"&amp;title="+o.title+'" class="DiggThisButton '+btn+'"></a><span style="display: none;">'+o.description+"</span>";break;case "delicious":btn="wide";if(o.size=="vertical")btn=
"tall";else if(o.size=="horizontal")btn="wide";b+='<script type="text/javascript" src="https://delicious-button.googlecode.com/files/jquery.delicious-button-1.1.min.js"><\/script><a class="delicious-button" href="https://delicious.com/save"><\!-- {url:"'+url+'",title:"'+o.title+'",button:"'+btn+'"} --\>Delicious</a>';break;case "pinterest":var bc="size-small";if(o.size=="vertical"){btn="vertical";bc="size-box"}else if(o.size=="horizontal")btn="horizontal";var count=0;jQuery.ajax({url:"https://api.pinterest.com/v1/urls/count.json?url="+
...
break;case "buffer":if(o.size=="vertical")btn="vertical";else if(o.size=="horizontal")btn="horizontal";b+='<a href="https://bufferapp.com/add" data-url="'+url+'" data-text="'+o.title+'" class="buffer-add-button" data-count="'+btn+'" data-via="'+o.twitterId+'">Buffer</a><script type="text/javascript" src="https://static.bufferapp.com/js/button.js"><\/script>';break;case "email":mailto=socialshare.email();b+='<a href="'+mailto+'" class="link-email"><span class="icon"></span>'+o.txtEmail+"</a>";break;
